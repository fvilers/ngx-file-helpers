...
Here's a list of the breaking changes upon the 16.0 release:

- Angular (core/common) version 22.0.0 or greater is a peer dependency;

Here's a list of the breaking changes upon the 15.0 release:

- Angular (core/common) version 21.0.0 or greater is a peer dependency;

Here's a list of the breaking changes upon the 14.0 release:

- Angular (core/common) version 20.0.0 or greater is a peer dependency;
